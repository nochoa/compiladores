...
public class PanelSimulation extends javax.swing.JFrame {
	...
	public PanelSimulation( AFD min, String[] nv) {
		cont = 0;
		cadena = nv;
		automata = min;
        initComponents();
    ...
    private void initComponents() {
       ...
       String pathPng = generatePathPng(automata.getProduction().getName().concat("SIMULATE"));
       ...
       javax.swing.GroupLayout tabsimLayout = new javax.swing.GroupLayout(tabsim);
       tabsim.setLayout(tabsimLayout);
       tabsimLayout.setHorizontalGroup(
           tabsimLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
           .addGroup(tabsimLayout.createSequentialGroup()
               .addContainerGap()
               .addGroup(tabsimLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                   .addGroup(tabsimLayout.createSequentialGroup()
                       .addComponent(jLabel8)
                       .addGap(27, 27, 27)
                       .addComponent(cadenav, javax.swing.GroupLayout.PREFERRED_SIZE, 333, javax.swing.GroupLayout.PREFERRED_SIZE)
                       .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 58, Short.MAX_VALUE)
                       .addComponent(bnext, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
       ...
       tabsimLayout.setVerticalGroup(
           tabsimLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
           .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, tabsimLayout.createSequentialGroup()
               .addGap(21, 21, 21)
               .addGroup(tabsimLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                   .addComponent(jLabel8)
       ...
       jTabbedPane1.addTab("Simulacion", tabsim);
       ...
       jTabbedPane1.getAccessibleContext().setAccessibleName("panel");
   ...
   public void next(ActionEvent e) throws AnalizadorLexicoException {
			...
			stateActual = graphicHelper.simulate(automata, cadena[cont], stateActual);
			if (stateActual == -1) {
